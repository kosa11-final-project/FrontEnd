...
const cardVariants = cva('rounded-[var(--radius-panel)] border text-[color:var(--text-body)]', {
  variants: {
    variant: {
...
export const Card = forwardRef(function Card({ asChild = false, className, variant, padding, ...props }, ref) {
  const Comp = asChild ? Slot : 'div';
  return <Comp ref={ref} data-slot="card" className={cn(cardVariants({ variant, padding }), className)} {...props} />;
});
...
export const CardTitle = forwardRef(function CardTitle({ as: Comp = 'h2', asChild = false, className, ...props }, ref) {
  ...
  return (
    <Component
      ...
      className={cn(
        'text-[length:var(--font-size-section-title)] font-[var(--font-weight-bold)] leading-[var(--line-height-heading)] text-[color:var(--text-heading)]',
        className,
      )}
      {...props}
    />
...
export const CardDescription = forwardRef(function CardDescription({ className, ...props }, ref) {
  return (
    <p
      ...
      className={cn(
        'text-[length:var(--font-size-body-sm)] leading-[var(--line-height-body)] text-[color:var(--text-muted)]',
        className,
      )}
      {...props}
    />
