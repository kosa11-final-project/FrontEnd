    ...
    <>
      <header className="flex min-w-0 items-start gap-3">
        ...
        <div className="min-w-0 flex-1">
          <h3 className="line-clamp-2 break-words text-[length:var(--font-size-body-sm)] font-[var(--font-weight-bold)] text-[color:var(--text-heading)]">{title}</h3>
          {eyebrow && <p className="mt-1 line-clamp-2 break-words text-[0.625rem] font-[var(--font-weight-bold)] uppercase tracking-[0.12em] text-[color:var(--text-label)]">{eyebrow}</p>}
        </div>
